module.exports = app => {
  ...
  // 统一看板内部聚合：仅允许同机回环请求和独立强令牌
  router.get('/api/internal/dashboard-stats', controller.internal.dashboardStats);
  router.get('/api/internal/user-analytics', controller.internal.userAnalytics);
